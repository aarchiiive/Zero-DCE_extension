...
if __name__ == "__main__":
    ...
    # Input Parameters
    parser.add_argument('--lowlight_images_path', type=str, default="Exdark_Train/")
    ...
    parser.add_argument('--snapshots_folder', type=str, default="Exdark/")
    parser.add_argument('--load_pretrain', type=bool, default=False)
    parser.add_argument('--pretrain_dir', type=str, default="weights/Epoch99.pth")
